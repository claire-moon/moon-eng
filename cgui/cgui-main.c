...
void drawChar(int x, int y, char c, int color) {
  ...
  unsigned char font[69][5] = {
    ...
    {0, 0, 0, 0, 0}, {0, 0, 0, 0, 2}, {0, 0, 0, 2, 4}, {0, 0, 0, 0, 7},
    {2, 2, 2, 0, 2,},{0, 0, 7, 0, 0}, {0, 2, 7, 2, 0}, {0, 7, 0, 7, 0},
    {0, 2, 0, 2, 0}, {0, 2, 0, 2, 4}, {1, 1, 2, 4, 4}, {4, 4, 2, 1, 1},
    {5, 5, 0, 0, 0}, {2, 2, 0, 0, 0}, {7, 1, 2, 0, 2}, {0, 5, 2, 5, 0},
    {7, 5, 5, 1, 7}, {5, 7, 5, 7, 5}, {7, 4, 7, 1, 7}, {5, 1, 2, 4, 5},
    {5, 1, 2, 4, 5}, {2, 5, 0, 0, 0}, {3, 4, 3, 5, 3}, {5, 2, 0, 0, 0},
    {4, 2, 0, 0, 0}, {3, 2, 6, 2, 3}, {6, 2, 3, 2, 6}, {2, 2, 2, 2, 2}
